...
- (Note: FASTA files which include human references are not included in this repo for storage reasons)
...
- R section (adjust names in scripts (e.g. specific env names) where necessary):
